...
const PageShell = ({ children, menuOpen, setMenuOpen }) => (
  <div className="main-page-wrapper d-flex flex-column" style={{ minHeight: '100vh' }}>
    <header className="header border-bottom">
        ...
        <div className="d-flex align-items-center gap-3">
            <Link to="/" className="d-flex align-items-center gap-3 text-decoration-none text-dark">
              <img src={logo} alt="Crowd Consensus" className="d-none d-md-block" style={{ height: 111, width: 124.44 }} />
        ...
        {menuOpen && (
            ...
            <ul className="nav flex-column gap-2 p-3">
                ...
                <li className="nav-item"><Link to="/profile" className="btn btn-primary w-100 mt-2" onClick={() => setMenuOpen(false)}>Profil</Link></li>
            </ul>
            </div>
        )}
        </div>
    ...
    <footer id="footer" className="bg-light mt-auto">
        ...
        <div className="row">
            ...
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer"
                ...
                <img src={discord} alt="Discord" style={{ width: 24, height: 24 }} /> Discord
            </a>
            </div>
            <div className="col-md-4 mb-4 mb-md-0">
            <h3>O nas</h3>
            <div className="d-flex flex-column">
                <Link to="/o-nas#about" className="text-dark text-decoration-none py-1">O nas</Link>
                <Link to="/kariera" className="text-dark text-decoration-none py-1">Kariera</Link>
                <Link to="/warunki-korzystania" className="text-dark text-decoration-none py-1">Warunki korzystania</Link>
                <Link to="/polityka-prywatnosci" className="text-dark text-decoration-none py-1">Polityka prywatności</Link>
                <Link to="/do-pobrania" className="text-dark text-decoration-none py-1">Do pobrania</Link>
                <Link to="/kontakt" className="text-dark text-decoration-none py-1">Kontakt</Link>
            </div>
            </div>
            <div className="col-md-4">
            <h3>Produkty</h3>
            <div className="d-flex flex-column">
                <Link to="/informacje-gieldowe" className="text-dark text-decoration-none py-1">Informacje giełdowe</Link>
                <Link to="/predykcje-gieldowe" className="text-dark text-decoration-none py-1">Predykcje giełdowe</Link>
                <Link to="/research" className="text-dark text-decoration-none py-1">Research</Link>
            </div>
            </div>
        </div>
        </div>
        <div className="text-center py-4 small text-muted border-top">
